...
_EMERGENCY_KW = (
    "护照丢", "护照丢了", "丢护照", "签证过期", "签证问题",
    "被咬", "被猴咬", "被蛇咬", "被狗咬", "受伤", "生病", "食物中毒", "过敏",
    "退票", "退款", "特价票", "改签", "航班取消", "航班延误", "误机",
    "被骗", "诱导", "转账", "被偷", "被抢", "丢钱包", "丢行李",
    "大使馆", "领事馆", "报警", "急救", "医院",
)


_UNSAFE_REQUEST_KW = (
    "逃票", "偷渡", "违禁", "非法", "伪造", "假证", "假报告",
    "系统提示词", "忘掉指令", "system prompt", "ignore",
    "手机号", "身份证号", "个人信息", "隐私",
    "威胁信", "威胁", "勒索", "抢票脚本", "外挂", "脚本",
    "假装你是", "扮演", "角色扮演",
    "内部员工", "后台数据", "管理员",
    "诱导转账", "私下转账", "诈骗",
    "政治观点", "政治敏感", "赞美某", "不当观点",

# Built-in knowledge entries for TravelMind knowledge base
# Separated from knowledge.py to respect the 500-line-per-file limit
from __future__ import annotations

from typing import List

from agent.memory.knowledge import KnowledgeEntry


def get_builtin_entries() -> List[KnowledgeEntry]:
  """Return all built-in knowledge entries (22 items)."""
  return [
    # === Japan - Visa ===
    KnowledgeEntry(
      title="日本签证政策（中国公民）",
    ...
    KnowledgeEntry(
      ...
      content=(
        "日本温泉（温泉/おんせん）指南：\n"
        "1. 温泉种类：露天风吕（室外）、内汤（室内）、足汤（足浴，免费体验）。\n"
    ...
    KnowledgeEntry(
      ...
      content=(
        ...
        "6. 推荐鱼种（按季节）：春-鯛鱼/初鰹鱼；夏-穴子；秋-鮭鱼/秋刀鱼；冬-金枪鱼/鰤鱼。\n"

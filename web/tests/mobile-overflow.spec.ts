...
test.describe("Mobile overflow - iPhone 14 Pro (393px)", () => {
  ...
  test("home page has no horizontal overflow", async ({ page }) => {
    ...
    await page.screenshot({ path: "web/tests/screenshots/mobile-home-14pro.png", fullPage: true });
  });

  test("chat page has no horizontal overflow", async ({ page }) => {
    await page.goto("/travel/chat");
    await page.waitForLoadState("networkidle");
    await assertNoOverflow(page);
    await page.screenshot({ path: "web/tests/screenshots/mobile-chat-empty-14pro.png", fullPage: true });
  });
  ...
  test("chat input is fully visible and usable", async ({ page }) => {
    ...
    await page.screenshot({ path: "web/tests/screenshots/mobile-chat-input-14pro.png" });
  });
  ...
  test("send message and verify bubble does not overflow", async ({ page }) => {
    ...
    await assertNoOverflow(page);
    await page.screenshot({ path: "web/tests/screenshots/mobile-chat-message-14pro.png" });
  });
});
...
test.describe("Mobile overflow - iPhone SE (320px)", () => {
  ...
  test("home page has no horizontal overflow on narrow screen", async ({ page }) => {
    ...
    await page.waitForLoadState("networkidle");
    await assertNoOverflow(page);
    await page.screenshot({ path: "web/tests/screenshots/mobile-home-se.png", fullPage: true });
  });
  ...
  test("chat page has no horizontal overflow on narrow screen", async ({ page }) => {
    ...
    await page.waitForLoadState("networkidle");
    await assertNoOverflow(page);
    await page.screenshot({ path: "web/tests/screenshots/mobile-chat-empty-se.png", fullPage: true });
  });
  ...
  test("guide cards do not overflow on narrow screen", async ({ page }) => {
    ...
    await page.screenshot({ path: "web/tests/screenshots/mobile-guide-cards-se.png", fullPage: true });
  });
  ...
  test("send long message on narrow screen", async ({ page }) => {
    ...
    await assertNoOverflow(page);
    await page.screenshot({ path: "web/tests/screenshots/mobile-chat-message-se.png" });
  });
});

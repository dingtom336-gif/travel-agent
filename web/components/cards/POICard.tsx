...
export default memo(function POICard({ data, onSelect }: POICardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-28 w-full overflow-hidden bg-gradient-to-br from-primary/20 to-secondary/20">
        {data.imageUrl ? (
          <img
            src={data.imageUrl}
            alt={data.name}
          ...
          <div className="flex h-full items-center justify-center">
            <svg className="h-10 w-10 text-primary/50" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        ...
        {/* Type badge */}
        <div className="absolute left-2 top-2 bg-surface-container-highest text-on-surface-variant rounded-full px-2 py-0.5 text-xs font-medium backdrop-blur-sm">
      ...
      <div className="p-2.5 sm:p-3">
        <div className="mb-1 flex items-start justify-between gap-1">
          ...
          <div className="flex shrink-0 items-center gap-0.5">
            ...
            <span className="text-xs font-medium text-primary">{data.rating}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between gap-1 text-xs text-on-surface-variant">
          {data.openingHours && (
